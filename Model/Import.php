            ...
            if ($file != '.' && $file != '..' && !is_dir($folder . $file) &&
                ...
                foreach ($aOrdersUpdated as $key => $orderToShip) {
                    try {
                        ...
                        $this->errorsMessages[] = sprintf(__('Shipment creation error for Order %s : %s'), $key, $e->getMessage());
                        $this->logger->glsLog('import : ' . sprintf(
                                __('Shipment creation error for Order %s : %s'),
                                $key,
                                $e->getMessage()
                            )
                        );
